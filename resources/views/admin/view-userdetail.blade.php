                ...
                <div class="card-body">
                    ...
                    <div class="tab-content" id="top-tabContent">
                        <div class="tab-pane fade show active" id="top-profile" role="tabpanel" aria-labelledby="top-profile-tab">
                            <h5 class="f-w-600">View School</h5>
                            <div class="table-responsive profile-table">
                                <table class="table table-responsive">
                                    <tbody>
                                        <form name="school_profile" method="POST" action="" enctype="multipart/form-data">
                                            @csrf
                                            <tr>
                                                <hr>
                                            </tr>
                                            <tr>
                                                <td>School Name :</td>
                                                <td><input type="text" id="name" name="name" value="{{ $userdetails->name }}" disabled></td>
                                            </tr>

                                            <tr>
                                                <td>Email Id :</td>
                                                <td><input type="email" id="email" name="email" value="{{ $userdetails->email }}" disabled></td>
                                            </tr>
                                            <tr>
                                                <td>Mobile Number :</td>
                                                <td><input type="text" id="mobile_number" name="mobile_number" value="{{ $userdetails->mobile_number }}" disabled></td>
                                            </tr>
                                            <tr>
                                                <td>City :</td>
                                                <td><input type="text" id="city" name="city" value="{{ $userdetails->city }}" disabled></td>
                                            </tr>
                                            <tr>
                                                <td>State :</td>
                                                <td><input type="text" id="state" name="state" value="{{ $userdetails->state }}" disabled></td>
                                            </tr>
                                            <tr>
                                                <td>Address :</td>
                                                <td><input type="text" id="address" name="address" value="{{ $userdetails->address }}" disabled></td>
                                            </tr>
                                            <tr>
                                                <td>PIN Code:</td>
                                                <td><input type="text" id="pin_code" name="pin_code" value="{{ $userdetails->pin_code }}" disabled></td>
                                            </tr>
                                    </tbody>
                                </table>
                            </div>
                            ...
                            <div class="table-responsive pancard-table">
                                <table class="table table-responsive">
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>Faculity Name:</td>
                                            <td> <input type="text" id="fname" name="faculity_name" value="" disabled></td>
                                        </tr>
                                        <tr>
                                            <td>Faculity Email:</td>
                                            <td> <input type="text" id="faculity_email" name="faculity_email" value="" disabled></td>
                                        </tr>
                                        <tr>
                                            <td>Faculity Mobile No:</td>
                                            <td> <input type="text" id="faculity_mobileno" name="faculity_mobileno" value="" disabled></td>
                                        </tr>
                                        <tr>
                                            <td>Faculity Gender:</td>
                                            <td> <input type="text" id="faculity_gender" name="faculity_gender" value="" disabled></td>
                                        </tr>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <input type="file" id="school_doc_image" name="school_document" accept="image/*" onchange="previewImage(this, 'documentPreview')">
                                                    <img id="documentPreview" src="" alt="School Document Preview" style="display: none; max-width: 200px; max-height: 200px; margin-top: 10px;" disabled>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                                            ...
                                            <div class="col-md-9">
                                                <div class="form-check">
                                                    ...
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="checkbox" name="books" id="" value="" data-book-id="">
    ...
    $(document).ready(function() {
        ...
        function checkBookAssociations() {
            $('.form-check-input').each(function() {
                var checkbox = $(this);
                var book_id = checkbox.data('book-id');
                var isBookAdded = isBookAssociatedWithSchool(book_id, '');
